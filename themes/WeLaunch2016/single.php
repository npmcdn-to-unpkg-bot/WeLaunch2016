...
<?php if( get_field('blog_hero') ) { ?>
	<div class="hero-lg" id="blog-hero" style="background-image: url('');">
<?php } else { ?>
...
<main class="container">
	<div class="row">
		<section class="col-xs-12 col-sm-12 col-md-10 col-lg-10 col-md-offset-1 col-lg-offset-1" id="blog-content">
			<a href="<?php bloginfo('url'); ?>/news" class="blog-bk-tag">Back to News</a>
